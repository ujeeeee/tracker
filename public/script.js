...
const IMPORT_CONFIG = {
    ...
    tea: {
        title: 'Импорт чая',
        hint: 'Группы — строки с <b>#</b>.<br>Формат: <code>Название | температура | отзыв | оценка</code> (отзыв и оценка — опционально)',
        placeholder: '# Бодрящий\nДа Хун Пао | 95 | Насыщенный, земляной\nТе Гуань Инь | 90-95 | Цветочный\n\n# Расслабляющий\nРомашка | 80-85 | Мягкий, успокаивающий',
    },
    places: {
        title: 'Импорт мест',
        hint: 'Типы — строки с <b>#</b>.<br>Формат: <code>Название | ссылка | заметка | приоритет</code>',
        placeholder: '# Кафе\nКафе Пушкин | https://... | вкусный лимонад | 5',
    },
    wishlist: {
